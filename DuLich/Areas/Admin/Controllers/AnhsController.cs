...
namespace DuLich.Areas.Admin.Controllers
{
    public class AnhsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDAnh,TenAnhDM,Anh1,Anh2,Anh3,Anh4,Anh5,Anh6")] Anh anh)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDAnh,TenAnhDM,Anh1,Anh2,Anh3,Anh4,Anh5,Anh6")] Anh anh)
        {
            if (ModelState.IsValid)
            {
